...
import CourseDetailsCard from '../../../legacy/components/CourseDetailsCard';

// Mock dependencies
vi.mock('../../utils/groupPrerequisites', () => ({
  groupPrerequisites: vi.fn((requisites: any[]) => {
    // Simple mock implementation
    const grouped: Record<string, any> = {};
    requisites.forEach((req: any) => {
      const key = req.type;
...
vi.mock('../../components/SectionModal', () => {
  return function MockCourseSectionButton({ title }: { title: string }) {
