...
export const SaveTimelineModal: React.FC<SaveTimelineModalProps> = ({ open, timelineName, onSave, onClose }) => {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "#fff", padding: 24, borderRadius: 8, minWidth: 320, boxShadow: "0 2px 8px rgba(0,0,0,0.2)" }}
        onClick={e => e.stopPropagation()}
      >
        <h2 style={{ marginBottom: 16 }}>Save Timeline</h2>
        <input
          type="text"
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
          <button onClick={onClose} style={{ padding: "8px 16px", borderRadius: 4, border: "none", background: "#eee" }}>Cancel</button>
          <button onClick={handleSave} style={{ padding: "8px 16px", borderRadius: 4, border: "none", background: "#007bff", color: "#fff" }}>
            Save
          </button>
        </div>
      </div>
