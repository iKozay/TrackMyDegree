...
const ScheduledCourses: React.FC<ScheduledCoursesProps> = ({ classes }) => {
    ...
    return (
        <div className="scheduled-courses-card">
            <style>{`
                ...
                .course-item__row + .course-item__row {
                    margin-top: 0.25rem;
                }
                ...
                {courses.map((course, i) => (
                    <div className="course-item" key={i}>
                        <div className="course-item__header">
                            <p className="course-item__name">{course.name} {course.section}</p>
                            <button className="course-item__delete" aria-label={`Remove ${course.name}`}>
