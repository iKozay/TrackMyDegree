        ...
        <div className="container my-5 sign-in-container">
          ...
          <form onSubmit={handleSignUp}>
            ...
            <div className="d-flex justify-content-between align-items-center mt-3">
              <Button className="btn-secondary" type="button" onClick={() => navigate(redirectTo ? `/signin?redirectTo=${redirectTo}` : '/signin')}>
                Cancel
              </Button>
          ...
          <div className="text-center mt-4">
            <Link to={redirectTo ? `/signin?redirectTo=${redirectTo}` : "/signin"}>
