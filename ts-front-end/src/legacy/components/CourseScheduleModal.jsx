...
export const CourseScheduleModal = ({ code }) => {
    ...
    return (
        <div>
            <button className="concordia-btn" onClick={fetchSections} disabled={loading}>
            ...
            <style>{`
                ...
                .concordia-btn {
                    background-color: #8a1538; /* Concordia Burgundy */
                    color: #ffffff;
                    border: none;
                    border-radius: 8px;
                    padding: 8px 10px;
                ...
                /* Hover */
                .concordia-btn:hover:not(:disabled) {
                    background-color: #74112f;
                    transform: translateY(-1px);
                    box-shadow: 0 6px 14px rgba(138, 21, 56, 0.35);
                }

                /* Active */
                .concordia-btn:active:not(:disabled) {
                    transform: translateY(0);
                    box-shadow: 0 3px 8px rgba(138, 21, 56, 0.3);
                }

                /* Disabled / Loading */
                .concordia-btn:disabled {
                    background-color: #c7a1ad;
                    cursor: not-allowed;
                    box-shadow: none;
                    opacity: 0.8;
                }
