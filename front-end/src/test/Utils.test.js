...
describe('arePrerequisitesMet', () => {
    ...
    test('returns true if course has no requisites', () => {
        ...
        expect(
            arePrerequisitesMet('COMP100', 1, courseInstanceMap, allCourses, semesters, semesterCourses)
        ).toBe(true);
    });
    ...
    test('returns true if prerequisites are met', () => {
        ...
        expect(
            arePrerequisitesMet('COMP200', 1, courseInstanceMap, allCourses, semesters, semesterCourses)
        ).toBe(true);
    });
    ...
    test('corequisites can be met in current semester', () => {
        ...
        expect(
            arePrerequisitesMet('COMP300', 1, courseInstanceMap, allCourses, semesters, semesterCourses)
        ).toBe(true);
    });
    ...
    test('grouped prerequisite met if at least one course in group is completed', () => {
        ...
        expect(
            arePrerequisitesMet('COMP400', 1, courseInstanceMap, allCourses, semesters, semesterCourses)
        ).toBe(true);
    });
});
...
describe('getTimelineInfo', () => {
    test('returns timelineData if not empty', () => {
        const timelineData = [
            { season: 'Fall', year: 2025, courses: ['COMP101'] }
        ];
...
describe('parseCourses', () => {
    ...
    test('parses exempted courses', () => {
        const timelineInfo = [
            { season: 'exempted', year: 2025, courses: ['MATH101'] },
        ];
    ...
    test('handles deficiencies', () => {
        const timelineInfo = [
            { term: 'deficiencies 2020', courses: ['COMP101'] },
        ];
