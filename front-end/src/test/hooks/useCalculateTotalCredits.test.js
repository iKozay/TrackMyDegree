...
describe('useCalculateTotalCredits', () => {
    ...
    it('should re-run effect when dependencies change', () => {
        const spy = jest.spyOn(timelineUtils, 'calculateTotalCredits2').mockReturnValue({ total: 10, unmetPrereqFound: false });
        ...
        const { rerender } = renderHook(
            ({ s }) => useCalculateTotalCredits(s, mockDispatch, remainingCourses),
