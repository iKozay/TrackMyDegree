...
describe('TimelinePage', () => {
  ...
  test('renders elements correctly', () => {
    ...
    expect(screen.getByText('Total Credits Earned: 0 / 120')).toBeInTheDocument();
  ...
  test('displays description when course is selected', async () => {
    ...
    expect(desc.innerHTML).toBe("Fundamentals of electric circuits: Kirchoff’s laws, voltage and current sources, Ohm’s law, series and parallel circuits. Nodal and mesh analysis of DC circuits. Superposition theorem, Thevenin and Norton Equivalents. Use of operational amplifiers. Transient analysis of simple RC, RL and RLC circuits. Steady state analysis: Phasors and impedances, power and power factor. Single and three phase circuits. Magnetic circuits and transformers. Power generation and distribution.")
  });
