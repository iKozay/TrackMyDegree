...
class DegreeDataScraper():
    ...
    def __init__(self):
        ...
        self.degree_scraper_config: list[DegreeScraperConfig] = [
            ...
            DegreeScraperConfig(long_name=ECPDegreeIDs.COMP_CA_ECP_ID, marker="Section 71.70.3 Extended Credit Program", ecp_degree_id="", short_name="COMP_CA_ECP", scraper_class=CompEcpDegreeScraper),
            DegreeScraperConfig(long_name=ECPDegreeIDs.COMP_DS_ECP_ID, marker="Section 71.70.3 Extended Credit Program", ecp_degree_id="", short_name="COMP_DS_ECP", scraper_class=CompEcpDegreeScraper),
