// Back-End/tests/__mocks__/pdf2json.js
const mockPdfParser = {
  on: jest.fn(),
  loadPDF: jest.fn()
};
      ...
      callback({
        Pages: [{
          Texts: [
            ...
            { R: [{ T: '3.75' }], y: -1 },
            { R: [{ T: 'Writing%20Skills%20Requirement%3A%20Satisfied' }], y: -1.5 },
            ...
            { R: [{ T: '20/08/2021%3A%20ASSESSED%3A%20ACCEPTABLE%20STANDING' }], y: -9 },
            ...
            // FIXED: Transfer Credits Section - needs pipe-separated format
            { R: [{ T: 'MATH%20%7C%20101%20%7C%20Precalculus%20%7C%20EX%20%7C%202019%20%7C%203.00%20%7C%20YEAR%20ATTENDED' }], y: -35 },
            { R: [{ T: 'PHYS%20%7C%20101%20%7C%20General%20Physics%20%7C%20PASS%20%7C%202019%20%7C%204.00%20%7C%20YEAR%20ATTENDED' }], y: -36 },
