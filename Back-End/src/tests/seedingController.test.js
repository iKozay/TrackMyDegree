...
describe("seedingController", () => {
    ...
    describe('seedDegreeData', () => {
        ...
        it('returns early for invalid degree name', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('Degree name "InvalidDegree" not found in degreesURL map.');
        ...
        it('runs scraper and seeds degree, course pools, and courses successfully', async () => {
            ...
            expect(bulkCreateCoursePoolsMock).toHaveBeenCalledWith(fakeData.course_pool);
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith('Course pools created for degree: Test Degree');
            expect(consoleLogSpy).toHaveBeenCalledWith('Courses created for degree: Test Degree');
        });
        ...
        it('updates degree when it already exists', async () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith('Degree deg2 already exists. Updated existing degree.');
        });
        ...
        it('handles error when creating/updating degree fails', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('Error creating/updating degree: deg3', error);
        });
        ...
        it('warns when some course pools are not created', async () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Some course pools may not have been created for degree: Test Degree');
        });
        ...
        it('warns when some courses are not created', async () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith('Some courses may not have been created for degree: Test Degree');
        });
        ...
        it('handles error when creating course pools or courses fails', async () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('Error creating course pools or courses for degree: Test Degree', error);
        });
    });
    ...
    describe('seedAllDegreeData', () => {
        ...
        it('runs seedAllDegreeData for all degrees in degreesURL', async () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith('Seeding completed for all degrees.');
        });
