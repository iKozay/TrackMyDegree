...
router.post('/logout', (req: Request, res: Response) => {
  ...
  res.clearCookie('access_token', { path: '/', httpOnly: true, secure, sameSite: 'strict' });
  res.clearCookie('refresh_token', { path: '/auth/refresh', httpOnly: true, secure, sameSite: 'strict' });
