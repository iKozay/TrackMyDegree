 ...
 */
async function createDeficiency(coursepool, user_id, creditsRequired) {
 ...
 */
async function getAllDeficienciesByUser(user_id) {
    const conn = await DBController_1.default.getConnection();
    if (conn) {
        try {
 ...
 */
async function deleteDeficiencyByCoursepoolAndUserId(coursepool, user_id) {
    const conn = await DBController_1.default.getConnection();
    if (conn) {
        try {
...
//# sourceMappingURL=deficiencyController.js.map