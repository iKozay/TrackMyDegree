...
const getUserData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userCheckResult = yield conn
            .request()
        ...
        const timelineResult = yield conn
            .request()
            .input('id', DBController_1.default.msSQL.VarChar, id)
        ...
        const deficiencyResult = yield conn
            .request()
            .input('id', DBController_1.default.msSQL.VarChar, id)
        ...
        const exemptionResult = yield conn
            .request()
            .input('id', DBController_1.default.msSQL.VarChar, id)
