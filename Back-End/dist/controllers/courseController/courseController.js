...
const redisClient_1 = __importDefault(require("@controllers/redisClient"));
...
function setCache(key, value, ttl) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield redisClient_1.default.setEx(key, ttl, value);
        }
        catch (err) {
...
function getAllCourses() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (dbConn) {
            try {
                const result = yield dbConn.request().query(`
        SELECT 
            c.code, 
            c.title, 
            c.credits, 
      ...
      `);
                ...
                try {
                    yield redisClient_1.default.setEx(cacheKey, 3600, JSON.stringify(resultData));
                }
                catch (cacheError) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (dbConn) {
            try {
                ...
                const courseResult = yield dbConn
                    .request()
                ...
                // Fetch requisites
                const requisitesResult = yield dbConn
                    .request()
 ...
 */
function getCoursesByDegreeGrouped(degreeId) {
    return __awaiter(this, void 0, void 0, function* () {
    ...
    `;
            ...
            try {
                ...
                yield redisClient_1.default.setEx(cacheKey, 604800, JSON.stringify(resultData));
            }
            catch (cacheError) {
                Sentry.captureException(new Error('Error writing to Redis cache'));
                log('Error writing to Redis cache', cacheError);
