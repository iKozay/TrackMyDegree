 ...
 */
async function createExemptions(coursecodes, user_id) {
 ...
 */
async function getAllExemptionsByUser(user_id) {
    const conn = await DBController_1.default.getConnection();
    if (conn) {
        try {
 ...
 */
async function deleteExemptionByCoursecodeAndUserId(coursecode, user_id) {
    const conn = await DBController_1.default.getConnection();
    if (conn) {
        try {
...
//# sourceMappingURL=exemptionController.js.map