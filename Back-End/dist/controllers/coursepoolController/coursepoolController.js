 ...
 */
async function createCoursePool(pool_name) {
 ...
 */
async function getCoursePool(pool_id) {
    const dbConn = await DBController_1.default.getConnection();
    if (dbConn) {
        try {
            const result = await dbConn
 ...
 */
async function updateCoursePool(update_info) {
    const dbConn = await DBController_1.default.getConnection();
    if (dbConn) {
 ...
 * @returns {Promise<DB_OPS>}
 */
async function removeCoursePool(pool_id) {
    const dbConn = await DBController_1.default.getConnection();
    if (dbConn) {
        try {
            const result = await dbConn
...
//# sourceMappingURL=coursepoolController.js.map