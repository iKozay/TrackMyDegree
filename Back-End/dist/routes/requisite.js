...
router.post('/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newRequisite = yield requisiteController_1.default.createRequisite(code1, code2, type);
...
router.post('/read', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Call the service function
        const requisites = yield requisiteController_1.default.readRequisite(code1, code2, type);
        // Send success response
...
router.post('/update', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Call the service function
        const updatedRequisite = yield requisiteController_1.default.updateRequisite(code1, code2, type);
        // Send success response
        res.status(HTTPCodes_1.default.OK).json({
...
router.post('/delete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Call the service function
        yield requisiteController_1.default.deleteRequisite(code1, code2, type);
        // Send success response
        res.status(HTTPCodes_1.default.OK).json({
