...
router.post('/create', async (req, res) => {
    ...
    try {
        ...
        const result = await exemptionController_1.default.createExemptions(coursecodes, user_id);
...
router.post('/getAll', async (req, res) => {
    ...
    try {
        ...
        // Call the service function
        const newExemption = await exemptionController_1.default.getAllExemptionsByUser(user_id);
        // Send success response
...
router.post('/delete', async (req, res) => {
    ...
    try {
        ...
        // Call the service function
        await exemptionController_1.default.deleteExemptionByCoursecodeAndUserId(coursecode, user_id);
        // Send success response
        res.status(HTTPCodes_1.default.OK).json({
