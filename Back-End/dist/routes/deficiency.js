...
router.post('/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newDeficiency = yield deficiencyController_1.default.createDeficiency(coursepool, user_id, creditsRequired);
...
router.post('/getAll', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Call the service function
        const newDeficiency = yield deficiencyController_1.default.getAllDeficienciesByUser(user_id);
        // Send success response
...
router.post('/delete', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Call the service function
        yield deficiencyController_1.default.deleteDeficiencyByCoursepoolAndUserId(coursepool, user_id);
        // Send success response
        res.status(HTTPCodes_1.default.OK).json({
